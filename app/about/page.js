...
<div className="flex items-start gap-8 mx-[44vh] mb-16">
  ...
  <div className="flex-1">
    <p className="text-4xl font-bold text-black text-justify">Ivan Sambat</p>
...
<div className="flex items-start gap-8 mx-[44vh] mb-16">
  ...
  <div className="flex-1">
    <p className="text-4xl font-bold text-black text-justify">Paul Marasigan</p>
...
<div className="flex items-start gap-8 mx-[44vh] mb-16">
  ...
  <div className="flex-1">
    <p className="text-4xl font-bold text-black text-justify">Jhune Magdurulan</p>
...
<div className="flex items-start gap-8 mx-[44vh] mb-16">
  ...
  <div className="flex-1">
    <p className="text-4xl font-bold text-black text-justify">Jhon Alonzo</p>
...
<div className="flex items-start gap-8 mx-[44vh] mb-16">
  ...
  <div className="flex-1">
    <p className="text-4xl font-bold text-black text-justify">Nicolette Gonio</p>
