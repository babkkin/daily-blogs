...
export default function BlogPage() {
	...
	return (
		<div className="max-w-4xl mx-auto px-6 py-12">
			<Link href="/" className="text-emerald-600 hover:underline mb-4 block">← Back to Blogs</Link>
			...
			<div className="text-gray-800 text-lg leading-relaxed whitespace-pre-line">{blog.content}</div>
		</div>
	);
}
