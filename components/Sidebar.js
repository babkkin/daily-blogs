              ...
              <div className="space-y-2">
                {displayedFollowing.map((user) => (
                  <Link
                    ...
                    className="flex items-center gap-3 p-2 border border-transparent text-gray-900/90 hover:mask-r-from-10% hover:border-black border-r-0 border-t-0 border-b-0 hover:bg-gray-100 hover:text-black cursor-pointer transition-all duration-300 ease-in-out"
                    onClick={onClose}
                  >
                    {user.profile_url ? (
                      <Image
